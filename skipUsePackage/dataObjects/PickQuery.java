...
public class PickQuery {
	...
	// The SearchOptionList is where you provide details on how you want to search
	// for Picks:
	private List<String> searchOptionList = new ArrayList<String>();
	...
	// trends.
	// SearchOption.PERCENT_GREATER_THAN + a percentage value of 0-100. Restrict the
	// returned Picks to ones with AutoRatePercentages greater than the provided
	// value. Example: `PERCENT_GREATER_THAN 80` to return Picks > 80% rated.
	// SearchOption.PERCENT_LESS_THAN + a percentage value of 0-100. Restrict the
	// returned Picks to ones with AutoRatePercentages less than the provided
	// value. Example: `PERCENT_LESS_THAN 80` to return Picks < 80% rated.
	...
	public void setOneSearchOptionList(String searchOption) {
	...
	public void setSearchOptionList(List<String> searchOptionList) {
		if (searchOptionList != null) {
			for (String searchOption : searchOptionList)
				addToSearchOptionList(searchOption);
		}
	}

	public void addToSearchOptionList(SearchOption searchOption) {
		if (searchOption != null && !getSearchOptionList().contains(searchOption.name()))
			this.searchOptionList.add(searchOption.name());
	}

	public void addToSearchOptionList(String searchOption) {
	...
	public void makeExactQuery() {
		getSearchOptionList().remove(SearchOption.GET_MORE_IF_SHORT.name());
		// Ignore 100 settings
